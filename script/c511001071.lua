...
function c511001071.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return (d and d:IsSetCard(0x8)) 
		or (Duel.IsExistingMatchingCard(c511001071.cfilter,tp,LOCATION_MZONE+LOCATION_GRAVE,0,1,nil) and Duel.IsPlayerCanDraw(tp,1)) end
...
function c511001071.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local sg=Duel.GetMatchingGroup(c511001071.cfilter,tp,LOCATION_MZONE+LOCATION_GRAVE,0,nil)
