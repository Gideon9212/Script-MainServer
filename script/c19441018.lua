...
function c19441018.spcon(e,c)
	...
	local rg=Duel.GetMatchingGroup(c19441018.spfilter,tp,LOCATION_MZONE+LOCATION_GRAVE,0,nil)
...
function c19441018.descost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local g=Duel.SelectMatchingCard(tp,c19441018.costfilter,tp,LOCATION_MZONE+LOCATION_GRAVE,0,1,1,nil)
	Duel.Remove(g,POS_FACEUP,REASON_COST)
end
