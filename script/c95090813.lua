...
function c95090813.initial_effect(c)
	...
	c:RegisterEffect(e2)
	aux.AddEREquipLimit(c,nil,c95090813.eqval,c95090813.equipop,e2)
end
function c95090813.eqval(ec,c,tp)
...
function c95090813.equipop(c,e,tp,tc)
