...
function c39041729.filter(c,e,tp)
	local rg=Duel.GetMatchingGroup(c39041729.cfilter,tp,LOCATION_MZONE+LOCATION_GRAVE,0,c)
	local lv=c:GetLevel()
...
function c39041729.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local rg=Duel.GetMatchingGroup(c39041729.cfilter,tp,LOCATION_MZONE+LOCATION_GRAVE,0,nil)
