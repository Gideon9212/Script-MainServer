...
function c38450736.initial_effect(c)
	...
	c:RegisterEffect(e1)
	aux.AddEREquipLimit(c,nil,c38450736.eqval,c38450736.equipop,e1)
	--equip effect
...
function c38450736.eqval(ec,c,tp)
...
function c38450736.equipop(c,e,tp,tc)
