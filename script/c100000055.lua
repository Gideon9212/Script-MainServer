...
function c100000055.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g1=Duel.GetMatchingGroup(aux.NecroValleyFilter(c100000055.filter),tp,0x13,0,nil,68140974,e,tp)
	local g2=Duel.GetMatchingGroup(aux.NecroValleyFilter(c100000055.filter),tp,0x13,0,nil,100000051,e,tp)
	local g3=Duel.GetMatchingGroup(aux.NecroValleyFilter(c100000055.filter),tp,0x13,0,nil,100000052,e,tp)
	local g4=Duel.GetMatchingGroup(aux.NecroValleyFilter(c100000055.filter),tp,0x13,0,nil,100000053,e,tp)
	local g5=Duel.GetMatchingGroup(aux.NecroValleyFilter(c100000055.filter),tp,0x13,0,nil,100000054,e,tp)
