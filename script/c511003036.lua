--さまようミイラ
function c511003036.initial_effect(c)
	--turn set
	...
	e1:SetTarget(c511003036.target)
	e1:SetOperation(c511003036.operation)
	c:RegisterEffect(e1)
end
function c511003036.target(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c511003036.operation(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
