...
function c46060017.desfilter(c,ft)
...
function c46060017.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chkc then return chkc:IsOnField() and chkc:IsControler(tp) and c46060017.desfilter(chkc,ft) end
	if chk==0 then return ft>-1 and Duel.IsExistingTarget(c46060017.desfilter,tp,LOCATION_ONFIELD,0,1,nil,ft)
		and Duel.IsExistingMatchingCard(c46060017.spfilter,tp,LOCATION_DECK,0,1,nil,e,tp) end
