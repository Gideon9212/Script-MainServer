...
function c511000248.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return c511000248.atktg(e,tp,eg,ep,ev,re,r,rp,0,chkc) end
	if chk==0 then return true end
	if Duel.CheckEvent(EVENT_BE_BATTLE_TARGET) and Duel.IsExistingTarget(c511000248.filter,tp,LOCATION_MZONE,LOCATION_MZONE,1,g) 
