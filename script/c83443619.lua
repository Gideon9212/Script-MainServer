...
function c83443619.desfilter(c,ft)
...
function c83443619.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chkc then return chkc:IsOnField() and chkc:IsControler(tp) and c83443619.desfilter(chkc,ft) end
	if chk==0 then return ft>-1 and Duel.IsExistingTarget(c83443619.desfilter,tp,LOCATION_ONFIELD,0,1,nil,ft)
		and Duel.IsExistingMatchingCard(c83443619.spfilter,tp,LOCATION_DECK,0,1,nil,e,tp) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_DESTROY)
	local g=Duel.SelectTarget(tp,c83443619.desfilter,tp,LOCATION_ONFIELD,0,1,1,nil,ft)
