...
function c511005704.initial_effect(c)
...
e1:SetTarget(c511005704.target)
e1:SetOperation(c511005704.operation)
c:RegisterEffect(e1)
end

function c511005704.operation(e,tp,eg,ep,ev,re,r,rp)
...
function c511005704.target(e,tp,eg,ep,ev,re,r,rp,chk)
local seq=e:GetHandler():GetPreviousSequence()
local tc=Duel.GetFieldCard(1-tp,LOCATION_SZONE,4-seq)
local tc2=Duel.GetFieldCard(tp,LOCATION_SZONE,seq)
