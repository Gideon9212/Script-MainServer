...
function c6133894.rfilter(c,ft,tp)
...
function c6133894.spcon(e,c)
	...
	return ft>-1 and Duel.CheckReleaseGroup(tp,c6133894.rfilter,1,nil,ft,tp)
end
function c6133894.spop(e,tp,eg,ep,ev,re,r,rp,c)
	local g=Duel.SelectReleaseGroup(tp,c6133894.rfilter,1,1,nil,Duel.GetLocationCount(tp,LOCATION_MZONE),tp)
