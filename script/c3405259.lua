...
function c3405259.initial_effect(c)
	aux.AddUnionProcedure(c,c3405259.unfilter)
	--immune
	local e1=Effect.CreateEffect(c)
	e1:SetType(EFFECT_TYPE_EQUIP)
	e1:SetCode(EFFECT_IMMUNE_EFFECT)
	e1:SetValue(c3405259.efilter)
	c:RegisterEffect(e1)
	--spsummon
	...
	e2:SetCondition(c3405259.spcon2)
	e2:SetTarget(c3405259.sptg2)
	e2:SetOperation(c3405259.spop2)
	c:RegisterEffect(e2)
end
function c3405259.unfilter(c)
