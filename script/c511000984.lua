...
function c511000984.filter(c,tp)
...
function c511000984.actg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_SZONE)>-1
		and Duel.IsExistingMatchingCard(c511000984.filter,tp,LOCATION_HAND,0,1,nil,tp) end
end
function c511000984.acop(e,tp,eg,ep,ev,re,r,rp)
	local tc=Duel.SelectMatchingCard(tp,c511000984.filter,tp,LOCATION_HAND,0,1,1,nil,tp):GetFirst()
