...
function c511001024.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then 	
		...
		e:SetLabel(0)
		return Duel.IsExistingMatchingCard(c511001024.costfilter,tp,LOCATION_MZONE+LOCATION_GRAVE,0,1,nil) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_REMOVE)
	local g=Duel.SelectMatchingCard(tp,c511001024.costfilter,tp,LOCATION_MZONE+LOCATION_GRAVE,0,1,1,nil)
