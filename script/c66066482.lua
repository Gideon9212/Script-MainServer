...
function c66066482.initial_effect(c)
	...
	c:RegisterEffect(e1)
	aux.AddEREquipLimit(c,nil,c66066482.eqval,c66066482.equipop,e1)
	--equip effect
...
function c66066482.eqval(ec,c,tp)
...
function c66066482.equipop(c,e,tp,tc)
