...
function c100305031.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	e2:SetOperation(c100305031.clearop)
...
function c100305031.spfilter(c,e,tp)
	return (c:IsCode(69514125) or c:IsSetCard(0x208)) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function c100305031.clearop(e,tp,eg,ep,ev,re,r,rp)
