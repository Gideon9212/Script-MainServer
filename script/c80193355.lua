...
function c80193355.cfilter(c,ft)
...
function c80193355.condition(e,tp,eg,ep,ev,re,r,rp)
	return eg:IsExists(c80193355.cfilter,1,nil,Duel.GetLocationCount(tp,LOCATION_MZONE))
end
...
function c80193355.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return ft>-1 and Duel.IsExistingMatchingCard(c80193355.spfilter,tp,LOCATION_HAND,0,1,nil,e,tp) end
	local g=eg:Filter(c80193355.cfilter,nil,ft)
