...
function c2204140.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingTarget(c2204140.rmfilter,tp,0,LOCATION_MZONE+LOCATION_GRAVE,1,nil)
	...
	local g2=Duel.SelectTarget(tp,c2204140.rmfilter,tp,0,LOCATION_MZONE+LOCATION_GRAVE,1,1,nil)
