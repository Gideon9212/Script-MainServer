...
function c55144522.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	elseif num==2 then
		...
		for i=1,3 do
			...
			if Duel.SpecialSummonStep(token,0,tp,tp,false,false,POS_FACEUP_DEFENSE) then
				...
				e2:SetOperation(c55144522.damop)
	...
	elseif num==20 then
		if Duel.GetLocationCount(tp,LOCATION_MZONE)>0
			...
			e2:SetOperation(c55144522.damop2)
			...
			e3:SetCountLimit(1)
			e3:SetCondition(c55144522.descon)
			e3:SetOperation(c55144522.desop)
...
function c55144522.damop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
...
function c55144522.descon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetTurnPlayer()==tp
end
function c55144522.desop(e,tp,eg,ep,ev,re,r,rp)
...
function c55144522.damop2(e,tp,eg,ep,ev,re,r,rp)
