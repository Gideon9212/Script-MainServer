...
function c100100108.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	e3:SetOperation(c100100108.reset)
	e3:SetReset(RESET_PHASE+PHASE_STANDBY+RESET_OPPO_TURN,res)
	c:RegisterEffect(e3)
end
function c100100108.reset(e,tp,eg,ep,ev,re,r,rp)
	c100100108.turnop(e:GetLabelObject(),tp,eg,ep,ev,e,r,rp)
end
...
function c100100108.turnop(e,tp,eg,ep,ev,re,r,rp)
	...
	if e:GetValue()==3 then
		e:SetValue(0)
		ct=ct-1
		e:GetLabelObject():SetCondition(c100100108.turncon2)
	end
	ct=ct+1
	e:SetLabel(ct)
	if ev==1082946 then
