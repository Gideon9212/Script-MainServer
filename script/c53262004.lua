...
function c53262004.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcMix(c,true,true,aux.FilterBoolFunction(Card.IsFusionSetCard,0x99),aux.FilterBoolFunctionEx(Card.IsType,TYPE_PENDULUM))
	--tohand
...
c53262004.material_setcode=0x99
