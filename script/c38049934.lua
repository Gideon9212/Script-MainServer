...
function c38049934.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return Duel.IsExistingMatchingCard(c38049934.cfilter,tp,LOCATION_MZONE+LOCATION_GRAVE,0,1,nil) end
	local g=Duel.GetMatchingGroup(c38049934.cfilter,tp,LOCATION_MZONE+LOCATION_GRAVE,0,nil)
