...
function c21790410.initial_effect(c)
	...
	c:RegisterEffect(e1)
	aux.AddEREquipLimit(c,nil,c21790410.eqval,c21790410.equipop,e1)
	--equip effect
...
function c21790410.eqval(ec,c,tp)
...
function c21790410.equipop(c,e,tp,tc)
