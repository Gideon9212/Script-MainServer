...
function c511000600.filter(c,tp)
...
function c511000600.tg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_SZONE)>0 and Duel.IsExistingMatchingCard(c511000600.filter,tp,LOCATION_HAND,0,1,nil,tp) end
end
function c511000600.op(e,tp,eg,ep,ev,re,r,rp)
	local tc=Duel.SelectMatchingCard(tp,c511000600.filter,tp,LOCATION_HAND,0,1,1,nil,tp):GetFirst()
