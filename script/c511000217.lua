...
function c511000217.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e) then
		...
		e1:SetCondition(c511000217.thcon)
		e1:SetOperation(c511000217.thop)
		e1:SetLabel(0)
		c:RegisterEffect(e1)
		local e2=Effect.CreateEffect(c)
		e2:SetType(EFFECT_TYPE_SINGLE)
		...
		e2:SetOperation(c511000217.reset)
		e2:SetReset(RESET_EVENT+0x1fe0000+RESET_PHASE+PHASE_STANDBY+RESET_SELF_TURN,3)
		c:RegisterEffect(e2)
	end
end
function c511000217.reset(e,tp,eg,ep,ev,re,r,rp)
	c511000217.thop(e:GetLabelObject(),tp,eg,ep,ev,e,r,rp)
end
function c511000217.thcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetTurnPlayer()==tp
end
function c511000217.thop(e,tp,eg,ep,ev,re,r,rp)
