...
function c4088.cost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c4088.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,c4088.filter2,tp,LOCATION_EXTRA,0,1,1,nil,tc:GetCode(),e,tp)
	local sc=g:GetFirst()
	if sc then
