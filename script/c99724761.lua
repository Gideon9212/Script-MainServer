...
function c99724761.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcMix(c,true,true,62651957,64500000)
	aux.AddContactFusion(c,c99724761.contactfil,c99724761.contactop,c99724761.splimit)
	--destroy
...
function c99724761.contactfil(tp)
	return Duel.GetMatchingGroup(Card.IsAbleToRemoveAsCost,tp,LOCATION_ONFIELD,0,nil)
end
function c99724761.contactop(g)
