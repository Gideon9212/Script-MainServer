...
function c511001552.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if sumtype&SUMMON_TYPE_FUSION==SUMMON_TYPE_FUSION and mg:GetCount()>0
		and mg:GetCount()<=ft and (not Duel.IsPlayerAffectedByEffect(tp,59822133) or mg:GetCount()==1) 
		and mg:FilterCount(aux.NecroValleyFilter(c511001552.mgfilter),nil,e,tp,tc)==mg:GetCount() then
		Duel.BreakEffect()
