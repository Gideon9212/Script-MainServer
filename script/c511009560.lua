...
function c511009560.initial_effect(c)
	--xyz summon
	aux.AddXyzProcedure(c,aux.FilterBoolFunctionEx(Card.IsRace,RACE_SPELLCASTER),5,2)
	c:EnableReviveLimit()
	--protection
...
function c511009560.atktg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
