--Speed Duel
--Scripted by Edo9300
function c96000001.initial_effect(c)
	--activate
	...
	e1:SetCountLimit(1)
	e1:SetRange(0xff)
	e1:SetCondition(c96000001.con)
	e1:SetOperation(c96000001.op)
	c:RegisterEffect(e1)
	--protection
...
function c96000001.con(e,tp,eg,ep,ev,re,r,rp)
    return Duel.GetTurnCount()==1
end
function c96000001.op(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.IsExistingMatchingCard(Card.IsCode,tp,LOCATION_REMOVED,0,1,nil,96000000) then
		...
		e1:SetLabel(seq)
		e1:SetOperation(c96000001.disop)
		e1:SetReset(0)
		Duel.RegisterEffect(e1,tp)
		end
	end
end
function c96000001.disop(e,tp)
