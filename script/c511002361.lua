...
function c511002361.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return Duel.IsExistingMatchingCard(c511002361.costfilter,tp,LOCATION_MZONE+LOCATION_GRAVE,0,1,nil) 
		and ct>0 end
	if ct>2 then ct=2 end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_REMOVE)
	local g=Duel.SelectMatchingCard(tp,c511002361.costfilter,tp,LOCATION_MZONE+LOCATION_GRAVE,0,1,ct,nil)
