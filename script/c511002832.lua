...
function c511002832.condition(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(c511002832.cfilter,tp,LOCATION_MZONE,0,1,nil,TYPE_PLUS) 
		and Duel.IsExistingMatchingCard(c511002832.cfilter,tp,LOCATION_MZONE,0,1,nil,TYPE_MINUS)
end
