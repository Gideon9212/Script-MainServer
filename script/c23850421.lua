...
function c23850421.costfilter(c,ft)
...
function c23850421.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return e:GetHandler():IsAbleToRemoveAsCost()
		and Duel.IsExistingMatchingCard(c23850421.costfilter,tp,LOCATION_MZONE,0,1,e:GetHandler(),ft) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_REMOVE)
	local rg=Duel.SelectMatchingCard(tp,c23850421.costfilter,tp,LOCATION_MZONE,0,1,1,e:GetHandler(),ft)
...
function c23850421.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>-2 and Duel.IsExistingTarget(c23850421.spfilter,tp,LOCATION_GRAVE,0,1,nil,e,tp) end
