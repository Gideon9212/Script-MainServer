...
function c811734.target(e,tp,eg,ep,ev,re,r,rp,chk)
	local b1=Duel.IsExistingMatchingCard(c811734.atkfilter,tp,LOCATION_MZONE+LOCATION_GRAVE,0,1,nil)
...
function c811734.activate(e,tp,eg,ep,ev,re,r,rp)
	if e:GetLabel()==0 then
		...
		local g=Duel.SelectMatchingCard(tp,c811734.atkfilter,tp,LOCATION_MZONE+LOCATION_GRAVE,0,1,1,nil)
