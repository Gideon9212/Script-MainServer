...
function c21296383.cfilter(c,lv,ft)
...
function c21296383.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return ft>-1 and e:GetHandler():IsAbleToRemoveAsCost()
		and Duel.IsExistingMatchingCard(c21296383.cfilter,tp,LOCATION_MZONE,0,1,e:GetHandler(),lv,ft) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_REMOVE)
	local g=Duel.SelectMatchingCard(tp,c21296383.cfilter,tp,LOCATION_MZONE,0,1,1,e:GetHandler(),lv,ft)
