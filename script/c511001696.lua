...
function c511001696.filter(c,tp)
...
function c511001696.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckReleaseGroup(tp,c511001696.filter,1,nil,tp) end
	local g=Duel.SelectReleaseGroup(tp,c511001696.filter,1,1,nil,tp)
