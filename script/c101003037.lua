...
function c101003037.initial_effect(c)
	...
	e1:SetDescription(aux.Stringid(101003037,0))
	e1:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e1:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_TRIGGER_O)
	e1:SetRange(LOCATION_HAND)
	e1:SetCode(EVENT_SUMMON_SUCCESS)
	e1:SetCondition(c101003037.condition)
	e1:SetTarget(c101003037.target)
	e1:SetOperation(c101003037.operation)
	c:RegisterEffect(e1)
	local e2=e1:Clone()
...
function c101003037.condition(e,tp,eg,ep,ev,re,r,rp)
	return eg:IsExists(c101003037.cfilter,1,nil,1-tp)
end
