...
function c511002649.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return Duel.GetLocationCountFromEx(tp)>1 and not Duel.IsPlayerAffectedByEffect(tp,59822133) 
...
function c511002649.operation(e,tp,eg,ep,ev,re,r,rp)
	if Duel.GetLocationCountFromEx(tp)<=1 or Duel.IsPlayerAffectedByEffect(tp,59822133) then return end
	local ect=c29724053 and Duel.IsPlayerAffectedByEffect(tp,29724053) and c29724053[tp]
