...
function c43959432.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	aux.AddEREquipLimit(c,nil,c43959432.eqval,c43959432.equipop,e,nil,RESET_EVENT+0x1fe0000)
	local tc=Duel.GetFirstTarget()
	if tc and tc:IsRelateToEffect(e) and tc:IsFaceup() then
		Duel.BreakEffect()
		c43959432.equipop(c,e,tp,tc)
	end
end
function c43959432.eqval(ec,c,tp)
	return ec:IsControler(tp) and ec:IsLevelAbove(4)
end
function c43959432.poscon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler()==Duel.GetAttacker() and e:GetHandler():IsRelateToBattle()
end
function c43959432.equipop(c,e,tp,tc)
	aux.EquipByEffectAndLimitRegister(c,e,tp,tc,43959432)		
end
...
function c43959432.atkval(e,c)
	local g=e:GetHandler():GetEquipGroup():Filter(c43959432.eqfilter,nil)
	local atk=0
	local tc=g:GetFirst()
	while tc do
...
function c43959432.eqfilter(c)
	return c:GetFlagEffect(43959432)~=0 
end
