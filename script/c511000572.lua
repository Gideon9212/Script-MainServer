...
function c511000572.initial_effect(c)
	...
	e1:SetCondition(c511000572.con)
	...
	e2:SetCondition(c511000572.con)
	...
	e3:SetCondition(c511000572.con)
	...
	e4:SetCondition(c511000572.con)
...
function c511000572.con(e,tp,eg,ep,ev,re,r,rp)
