...
function c511020000.filter(c)
	return c:IsSetCard(0xba) and c:IsType(TYPE_XYZ) and c:GetRank()<=5
end
function c511020000.descon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetOverlayGroup():IsExists(c511020000.filter,1,nil) and bit.band(e:GetHandler():GetSummonType(),SUMMON_TYPE_XYZ)==SUMMON_TYPE_XYZ
end
