...
function c511001541.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return sg:GetCount()>0 and Duel.GetLocationCountFromEx(tp)>0 end
...
function c511001541.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local sc=Duel.SelectMatchingCard(tp,c511001541.spfilter2,tp,LOCATION_EXTRA,0,1,1,nil,e,tp,tc):GetFirst()
