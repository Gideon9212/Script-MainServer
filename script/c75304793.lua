...
function c75304793.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local b2=e:GetHandler():IsCanRemoveCounter(tp,0x35,7,REASON_COST)
		and Duel.IsExistingMatchingCard(c75304793.rmfilter,tp,0,LOCATION_ONFIELD+LOCATION_GRAVE,1,nil)
...
function c75304793.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if e:GetLabel()==0 then
		...
		local g=Duel.SelectMatchingCard(tp,c75304793.rmfilter,tp,0,LOCATION_ONFIELD+LOCATION_GRAVE,1,ct,nil)
