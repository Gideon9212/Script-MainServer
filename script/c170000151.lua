...
function c170000151.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c170000151.spfilter,tp,LOCATION_EXTRA,0,1,nil,e,tp) end
...
function c170000151.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if sc then
		...
		local tg=Duel.SelectMatchingCard(tp,c170000151.tgfilter,tp,LOCATION_ONFIELD,0,1,1,nil,code,sc)
