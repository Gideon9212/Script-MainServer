...
function c61613388.mzfilter(c,tp)
...
function c61613388.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return g:GetCount()>0 and Duel.GetLocationCount(tp,LOCATION_MZONE)+g:FilterCount(c61613388.mzfilter,nil,tp)>0
