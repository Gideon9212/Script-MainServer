...
function c72029628.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
		local chkf=tp
		local mg1=Duel.GetMatchingGroup(c72029628.filter0,tp,LOCATION_MZONE+LOCATION_GRAVE,0,nil)
...
function c72029628.activate(e,tp,eg,ep,ev,re,r,rp)
	local chkf=tp
	local mg1=Duel.GetMatchingGroup(c72029628.filter1,tp,LOCATION_MZONE+LOCATION_GRAVE,0,nil,e)
