...
function c100332041.initial_effect(c)
	...
	e1:SetDescription(aux.Stringid(100332041,0))
	e1:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_TRIGGER_O)
	e1:SetCode(EVENT_BATTLE_CONFIRM)
	e1:SetCountLimit(1)
	e1:SetRange(LOCATION_MZONE)
	e1:SetCondition(c100332041.condition)
	e1:SetOperation(c100332041.operation)
	c:RegisterEffect(e1)
end
function c100332041.condition(e,tp,eg,ep,ev,re,r,rp)
...
function c100332041.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	e2:SetOperation(c100332041.damop)
