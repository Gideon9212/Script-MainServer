...
function c511001698.filter(c,tp)
...
function c511001698.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckReleaseGroup(tp,c511001698.filter,1,nil,tp) end
	local g=Duel.SelectReleaseGroup(tp,c511001698.filter,1,1,nil,tp)
