...
function c25793414.initial_effect(c)
	c:EnableReviveLimit()
	aux.AddFusionProcMix(c,true,true,14577226,aux.FilterBoolFunction(Card.IsFusionSetCard,0xf0))
	--copy
...
c25793414.listed_names={14577226,25793414}
c25793414.miracle_synchro_fusion=true
c25793414.material_setcode=0xf0
