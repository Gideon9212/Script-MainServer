...
function c77498348.spcon(e,c)
	...
	return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		...
		and Duel.IsExistingMatchingCard(c77498348.spfilter,tp,LOCATION_MZONE+LOCATION_GRAVE,0,ct,nil,e:GetLabel())
end
function c77498348.spop(e,tp,eg,ep,ev,re,r,rp,c)
	local g=Duel.GetMatchingGroup(c77498348.spfilter,tp,LOCATION_MZONE+LOCATION_GRAVE,0,nil,e:GetLabel())
