...
function c34079868.rescon(sg,e,tp,mg)
	return aux.ChkfMMZ(1)(sg,e,tp,mg) and sg:IsExists(c34079868.chk,1,nil,sg)
end
function c34079868.chk(c,sg)
...
function c34079868.spcon(e,c)
	...
	return Duel.GetLocationCount(tp,LOCATION_MZONE)>-2 and g1:GetCount()>0 and g2:GetCount()>0 and g:GetCount()>1 
		and aux.SelectUnselectGroup(g,e,tp,2,2,c34079868.rescon,0)
end
function c34079868.spop(e,tp,eg,ep,ev,re,r,rp,c)
	...
	local g2=rg:Filter(Card.IsSetCard,nil,0xda)
	g1:Merge(g2)
	local sg=aux.SelectUnselectGroup(g1,e,tp,2,2,c34079868.rescon,1,tp,HINTMSG_RELEASE)
