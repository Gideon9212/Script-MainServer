...
function c511009593.initial_effect(c)
	--Fusion summon
	aux.AddFusionProcMix(c,true,true,aux.FilterBoolFunction(Card.IsFusionSetCard,0x10af),aux.FilterBoolFunction(Card.IsFusionSetCard,0xaf))
	c:EnableReviveLimit()
	--pendulum summon
	...
	e6:SetTarget(c511009593.atktg)
	e6:SetOperation(c511009593.atkop)
	c:RegisterEffect(e6)
end
function c511009593.damtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
