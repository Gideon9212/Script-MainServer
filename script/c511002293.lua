...
function c511002293.initial_effect(c)
	...
	c:RegisterEffect(e2)
	aux.AddEREquipLimit(c,c511002293.eqcon,function(ec,_,tp) return ec:IsControler(1-tp) end,c511002293.equipop,e2)
end
...
function c511002293.eqcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsSummonType(SUMMON_TYPE_ADVANCE+1)
end
...
function c511002293.equipop(c,e,tp,tc)
