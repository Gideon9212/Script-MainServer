...
function c511009324.filter2(c,tp,mc)
...
function c511009324.filter(c,tp)
	...
	return g:IsExists(c511009324.eqfilter,1,nil) and c:IsAbleToGrave() 
		and Duel.IsExistingTarget(c511009324.filter2,tp,LOCATION_ONFIELD,0,1,c,tp,c)
end
...
function c511009324.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_TOGRAVE)
	local g2=Duel.SelectTarget(tp,c511009324.filter2,tp,LOCATION_ONFIELD,0,1,1,tc,tp,tc)
	g1:Merge(g2)
