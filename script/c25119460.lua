...
function c25119460.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcMix(c,true,true,65622692,64500000)
	aux.AddContactFusion(c,c25119460.contactfil,c25119460.contactop,c25119460.splimit)
	--destroy
...
function c25119460.contactfil(tp)
	return Duel.GetMatchingGroup(Card.IsAbleToRemoveAsCost,tp,LOCATION_ONFIELD,0,nil)
end
function c25119460.contactop(g)
