...
function c511001376.rettg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return (gm:GetCount()>0 and Duel.GetLocationCount(tp,LOCATION_MZONE)>gm:GetCount()-1) 
		or (gst:GetCount()>0 and Duel.GetLocationCount(tp,LOCATION_SZONE)>gst:GetCount()-1) end
