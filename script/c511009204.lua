...
function c511009204.filter(c,e,tp)
	return c:IsSetCard(0x552) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
function c511009204.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingMatchingCard(c511009204.filter,tp,LOCATION_DECK,0,1,nil,e,tp) end
