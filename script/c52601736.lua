...
function c52601736.initial_effect(c)
	...
	c:RegisterEffect(e1)
	aux.AddEREquipLimit(c,nil,c52601736.eqval,c52601736.equipop,e1)
	--equip effect
...
function c52601736.eqval(ec,c,tp)
...
function c52601736.equipop(c,e,tp,tc)
