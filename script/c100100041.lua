...
function c100100041.filter(c)
	return c:GetType()&0x81==0x81 and c:GetLevel()<=7 and c:IsAbleToHand()
end
...
function c100100041.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.GetMatchingGroup(aux.NecroValleyFilter(c100100041.filter2),tp,LOCATION_GRAVE,0,nil)
