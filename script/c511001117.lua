...
function c511001117.initial_effect(c)
	...
	c:RegisterEffect(e1)
	aux.AddEREquipLimit(c,nil,aux.FilterBoolFunction(Card.IsRace,RACE_DRAGON),c511001117.equipop,e1)
	--atkup
...
function c511001117.equipop(c,e,tp,tc)
