...
function c25542642.initial_effect(c)
	aux.AddPersistentProcedure(c,nil,c25542642.filter,CATEGORY_DISABLE,nil,nil,0x1c0,nil,nil,c25542642.target)
...
function c25542642.target(e,tp,eg,ep,ev,re,r,rp,tc,chk)
