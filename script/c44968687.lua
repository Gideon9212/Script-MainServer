...
function c44968687.cfilter(c,ft,tp)
...
function c44968687.spcon(e,c)
	...
	return ft>-1 and Duel.CheckReleaseGroup(tp,c44968687.cfilter,1,nil,ft,tp)
end
function c44968687.spop(e,tp,eg,ep,ev,re,r,rp,c)
	local g=Duel.SelectReleaseGroup(tp,c44968687.cfilter,1,1,nil,Duel.GetLocationCount(tp,LOCATION_MZONE),tp)
...
function c44968687.damval(e,re,val,r,rp,rc)
	...
	if Duel.GetFlagEffect(tp,44968687)==0 or r&REASON_BATTLE+REASON_EFFECT==0 then return val end
