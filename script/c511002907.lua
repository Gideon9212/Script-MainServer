...
function c511002907.initial_effect(c)
	...
	c:RegisterEffect(e3)
	if not c511002907.global_check then
		c511002907.global_check=true
		local ge2=Effect.CreateEffect(c)
		ge2:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_CONTINUOUS)
		ge2:SetCode(EVENT_ADJUST)
		ge2:SetCountLimit(1)
		ge2:SetProperty(EFFECT_FLAG_NO_TURN_RESET)
		ge2:SetOperation(c511002907.archchk)
		Duel.RegisterEffect(ge2,0)
	end
end
function c511002907.archchk(e,tp,eg,ep,ev,re,r,rp)
...
function c511002907.filter(c,e,tp)
	return c:IsIvy() and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function c511002907.sumop(e,tp,eg,ep,ev,re,r,rp)
	...
	if not Duel.IsPlayerCanSpecialSummonMonster(tp,30069399,0x52b,0x4011,0,0,1,RACE_PLANT,ATTRIBUTE_EARTH,POS_FACEUP_DEFENSE,1-tp) then return end
	for i=1,2 do
