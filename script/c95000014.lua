...
function c95000014.initial_effect(c)
	...
	c:RegisterEffect(e6)
	aux.AddEREquipLimit(c,nil,aux.FilterBoolFunction(Card.IsType,TYPE_MONSTER),c95000014.equipop,e6)
...
function c95000014.equipop(c,e,tp,tc)
